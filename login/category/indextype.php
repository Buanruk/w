    ...
    <main>
        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
               ...
               <a href="insert.php" class="btn btn-success"><i class="bi bi-upload"></i> เพิ่มประเภทสินค้า </a>
...
?>
            ...
            <tr>
              <td>
    <a href="update.php?id=<?= $data['pt_id']; ?>" class="btn btn-warning btn-sm">
        <i class="bi bi-pencil-square"></i> Edit
    </a>
</td>

<td>
    <a href="delete.php?id=<?= $data['pt_id']; ?>" class="btn btn-danger btn-sm" 
       onclick="return confirm('คุณแน่ใจว่าต้องการลบประเภทสินค้านี้?');">
